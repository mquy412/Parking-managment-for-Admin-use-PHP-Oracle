...
<html lang="en">
  ...
  <body>
    ...
    <?php
    $query = "SELECT * FROM MANAGER1.ParkingSpaces";
    ...
    echo "<div class=custom-row>";
        ...
        if($row['SPACE_STATUS_ID'] == 1){
            echo "<div class=custom-col-color>" . $row['SPACE_ID'] . "</div>";
        }
        else {
            echo "<div class=custom-col>" . $row['SPACE_ID'] . "</div>";
        }
    }
